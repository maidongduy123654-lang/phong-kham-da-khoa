...
# 🏥 Hệ Thống Quản Lý Phòng Khám / Bệnh Viện Thông Minh (Clinic Management System)

Tài liệu này mô tả chi tiết workflow (luồng công việc) của các nhóm người dùng (User Roles) chính tham gia vào hệ thống, phục vụ cho việc phát triển phần mềm và thiết kế luồng nghiệp vụ.
...
### 1. Bệnh nhân (Patient)
*   **Trigger (Điểm bắt đầu):** Có nhu cầu khám bệnh hoặc đến lịch hẹn tái khám.
*   **Actions (Các bước thực hiện):**
...
*   **Outputs (Kết quả đầu ra):** Đặt lịch thành công, mã số thứ tự khám, biên lai thanh toán, đơn thuốc điện tử và hồ sơ bệnh án cá nhân được cập nhật.

### 2. Lễ tân (Receptionist)
*   **Trigger (Điểm bắt đầu):** Bệnh nhân đến quầy trực tiếp hoặc liên hệ qua số hotline của phòng khám.
*   **Actions (Các bước thực hiện):**
...
*   **Decisions (Điểm quyết định):** Kiểm tra xem bệnh nhân đã có thông tin trên hệ thống chưa.
...
*   **Outputs (Kết quả đầu ra):** Phiếu số thứ tự khám của bệnh nhân, trạng thái hàng đợi tại các phòng khám được cập nhật theo thời gian thực trên hệ thống.

### 3. Bác sĩ (Doctor)
*   **Trigger (Điểm bắt đầu):** Hệ thống phần mềm thông báo có bệnh nhân tiếp theo đang đợi trước cửa phòng khám.
*   **Actions (Các bước thực hiện):**
...
*   **Decisions (Điểm quyết định):** Đánh giá xem triệu chứng lâm sàng đã đủ rõ ràng để kết luận chưa.
...
*   **Outputs (Kết quả đầu ra):** Đơn thuốc điện tử, phiếu chỉ định cận lâm sàng, chẩn đoán bệnh lý và phác đồ điều trị được lưu trữ đồng bộ vào hồ sơ bệnh án điện tử (EMR).

### 4. Quản trị viên (Admin)
*   **Trigger (Điểm bắt đầu):** Đăng nhập vào trang quản trị hệ thống (Dashboard dành riêng cho Admin).
*   **Actions (Các bước thực hiện):**
...
*   **Decisions (Điểm quyết định):** Theo dõi xem hệ thống vận hành có gặp sự cố kỹ thuật hoặc tình trạng quá tải cục bộ tại các phòng khám không.
...
*   **Outputs (Kết quả đầu ra):** Lịch trực nhân sự được tối ưu hóa, báo cáo tài chính được phê duyệt, hệ thống phần mềm hoạt động ổn định và bảo mật dữ liệu y tế được đảm bảo.
